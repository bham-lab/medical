...
import { bookAppointmen } from "../../../../actions/appointment";
...
console.log("doctor id: ", doctorId);
      ...
      const { loading,data,fn: submitBooking} = UseFetch(bookAppointmen);
...
useEffect(()=>{
    ...
    return(
        ...
        <form className="space-y-6" onSubmit={handlesubmit}>
          <div className="bg-muted/290bp-4 rounded-lg border border-emerald-900/20 space-y-3">
            ...
            <span  className="text-muted-foreground">
                ...
                <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground"> 
                            This information wiil be shared with the doctor before your appointment.
                        </p>
