         ...
         <div>
              ...
              <CardContent className ="pt-4">
                <div className ="flex items-start gap-4">
                    ...
                    <div className=" w-12 h-12 rounded-full bg-emerald-900/20 flex items-center justify-center flex-shrik-1">
                            {doctor.imageUrl ? (
                    <img     
                    src={doctor.imageUrl}
                    alt={doctor.name}
                    className="h-6 w-6 text-emerald-400 rounded-full object-cover" />
                ):(
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground mb-1">
                            ...
                            className="w-full bg-emerald-500 hover:bg-emerald-600 mt-2">
                                <Link href={`/doctors/${doctor.specialty}/${doctor.id}`} className="flex" >
